...
REST is not a technology—it is an **architectural style** used when designing web services. When APIs follow REST principles, we commonly refer to them as **REST APIs**.
<br />
...
This foundation is essential for understanding modern web development.
